...
const WebSocketManager = {
    ...
    handleCommand: function(message) {
        ...
        if (window.App) {
            ...
            // 转发到蓝牙
            if (App.state.bluetoothConnected) {
                App.sendBluetoothData(command + '\r\n');
            } else {
    ...
    updateConnectionStatus: function(connected) {
        ...
        if (connected) {
            statusElement.querySelector('.status-dot').className = 'status-dot online';
            textElement.textContent = '服务器已连接';
            wsStatusElement.textContent = '已连接';
            wsStatusElement.style.color = 'var(--success-color)';
        } else {
            statusElement.querySelector('.status-dot').className = 'status-dot offline';
            textElement.textContent = '服务器未连接';
            wsStatusElement.textContent = '未连接';
            wsStatusElement.style.color = 'var(--danger-color)';
        }
    },
